...
!==============================================================================|
   USE ALL_VARS
   IMPLICIT NONE 
   REAL(SP), DIMENSION(0:NTNode,1:KB), INTENT(IN)  :: NVAR  
   REAL(SP), DIMENSION(0:MTElem,1:KB), INTENT(OUT) :: EVAR  
   INTEGER I,K
!------------------------------------------------------------------------------|
...
!==============================================================================|
   USE ALL_VARS
   IMPLICIT NONE
   REAL(SP), DIMENSION(0:NTNode), INTENT(IN)  :: NVAR 
   REAL(SP), DIMENSION(0:MTElem), INTENT(OUT) :: EVAR  
   INTEGER I,K
!------------------------------------------------------------------------------|
...
!==============================================================================|
   USE ALL_VARS
   IMPLICIT NONE
   REAL(SP), DIMENSION(0:MTElem), INTENT(IN ) :: EVAR  
   REAL(SP), DIMENSION(0:NTNode), INTENT(OUT) :: NVAR 
   INTEGER I,K
!------------------------------------------------------------------------------|
...
!==============================================================================|
   USE ALL_VARS
   IMPLICIT NONE
   REAL(SP), DIMENSION(0:MTElem,KB), INTENT(IN ) :: EVAR  
   REAL(SP), DIMENSION(0:NTNode,KB), INTENT(OUT) :: NVAR 
   INTEGER I,K
!------------------------------------------------------------------------------|
