...
MODULE MOD_KELP
 ...
 !  USE MOD_TYPES
   ...
   CONTAINS !-----------------------------------------------------------------------|
            ! DATA_RUN_KELP : Input Parameters Which Control 1 MODULE            |
            ! IOFILES_KELP  : Open Input Files for 1 MODULE                      |
...
!==============================================================================!
!   Open & Read Input Files for 1 Calculation                                !
!==============================================================================!
...
!initialized arrays to ZERO
   ...
   DO I=1, MElemGL       !read in element-based inputs
      do K=1, KBM1
         ...
         write(102,*)     eid, kid, n_of_kelp_gl(i,k), kelp_area_gl(i,k),&
                          drag_coef_gl(i,k)
      end do
   END DO
   CLOSE(KELP_MAP)
