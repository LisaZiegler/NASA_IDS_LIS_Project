...
Big_array_out(:,:,3)=nc{'SSI'}(end,:,:);
Big_array_out(:,:,4)=0.05; %nc{'B1'}(end,:,:); %ALG1
Big_array_out(:,:,5)=0.05; %nc{'B2'}(end,:,:); %ALG2
...
Big_array_out(:,:,13)=0.1;%nc{'NH4'}(end,:,:); %NH4
Big_array_out(:,:,14)=0.1;%nc{'NO3'}(end,:,:); % %N03
...
Big_array_out(:,:,27)=9.0;%nc{'DOXG'}(end,:,:); %DO2
