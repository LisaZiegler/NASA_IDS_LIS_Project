...
for idir = 1 : numfile;
    ...
    for istat = 1: length(stations_mod)
        ...
        mod_salt(:,:,istat) = nc{'temp'}(:,:,stations_mod(istat));
    ...
    % now for each unique date, find corresponding values and take the
      ...
      % get the matching model times for statistics and plotting;   
       ...
       subplot(2,2,[1,2]);
        ...
        title([ 'Temp' , 'r =' num2str(r) ', RMSE = ' num2str(RMSE)   ' WMS = ' num2str(WMS)]);
        ...
        subplot(2,2,3)
         ...
         title([ 'TEMP ' , '  MEF =' num2str(MEF),'r = ',num2str(r) ', RMSE = ' num2str(RMSE) , ' MPE = ',num2str(MPE)  ' WMS = ' num2str(WMS),'RI = ',num2str(RI)]);
     ...
     mkdir(  ['station' num2str(istat)])
        ...
        saveas(gcf,['station' num2str(istat) '/TEMP_depth' num2str(istat)],'png');
     ...
     plot(unique_dates_out,X_out_mean,'r-*');
         title([ 'Depth Averaged Temp ' , '  MEF =' num2str(MEF),'r = ',num2str(r) ', RMSE = ' num2str(RMSE) , ' MPE = ',num2str(MPE)  ' WMS = ' num2str(WMS),'RI = ',num2str(RI)]);
     ...
     % xlabel('Observed Salt (PSU)','Fontsize',20);ylabel('Modeled Salinity (PSU)','Fontsize',20);
      ...
      subplot(2,2,4);
       ...
       % xlabel('Salt (PSU)','Fontsize',20);ylabel('Probability','fontsize',20)
        ...
        saveas(gcf,['station' num2str(istat) '/temp_depth_stats' num2str(istat)],'png');
